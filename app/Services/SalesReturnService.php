...
class SalesReturnService
{
    ...
    public function createReturn(array $data): SalesReturn
    {
        ...
        $validated = validator($data, [
            ...
            'items.*.item_condition' => 'nullable|in:new,used,damaged,defective,expired',
            ...
            callback: fn () => DB::transaction(function () use ($validated) {
                ...
                foreach ($validated['items'] as $itemData) {
                    ...
                    $returnItem = SalesReturnItem::create([
                        ...
                        'item_condition' => $itemData['item_condition'] ?? SalesReturnItem::CONDITION_NEW,
    ...
    protected function restockItems(SalesReturn $return, int $userId): void
    {
        ...
        foreach ($return->items as $item) {
            ...
            $this->stockService->adjustStock(
                ...
                notes: "Restocked from sales return (item: {$item->id}) - Condition: ".($item->item_condition ?? 'unspecified'),
