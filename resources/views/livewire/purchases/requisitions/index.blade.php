                                ...
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    @can('purchases.requisitions.approve')
                                        @if($requisition->status === 'pending')
                                            ...
                                            <button type="button" wire:click="reject({{ $requisition->id }}, '{{ __('Rejected') }}')" class="text-red-600 hover:text-red-800" title="{{ __('Reject') }}">
                                    ...
                                    @can('purchases.requisitions.manage')
                                        <button type="button" onclick="return confirm('{{ __('Are you sure?') }}')" wire:click="delete({{ $requisition->id }})" class="text-slate-600 hover:text-slate-900" title="{{ __('Delete') }}">
