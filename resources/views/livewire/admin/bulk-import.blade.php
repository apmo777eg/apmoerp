        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm">
            ...
            <div class="p-6 space-y-6">
                <div class="flex items-center justify-between">
                    ...
                    <button type="button" wire:click="downloadTemplate" class="text-sm text-emerald-600 hover:text-emerald-700 flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-slate-200 dark:border-slate-700 px-6 py-4 flex justify-between">
                @if($currentStep > 1)
                <button type="button" wire:click="previousStep" class="px-4 py-2 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition">
                    {{ __('Back') }}
                </button>
                @else
                <div></div>
                ...
                @if($currentStep < 3)
                <button type="button" wire:click="nextStep" class="px-4 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition">
                    {{ __('Next') }}
                </button>
                @elseif(empty($importResult))
                <button type="button" wire:click="runImport" class="px-4 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition flex items-center gap-2" wire:loading.attr="disabled">
