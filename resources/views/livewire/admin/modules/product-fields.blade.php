                                ...
                                <tr class="hover:bg-slate-50 transition-colors {{ !$field['is_active'] ? 'opacity-50' : '' }}">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button type="button" wire:click="delete({{ $field['id'] }})" wire:confirm="{{ __('Are you sure you want to delete this field?') }}" class="p-1.5 text-red-600 hover:bg-red-50 rounded-lg" title="{{ __('Delete') }}">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
